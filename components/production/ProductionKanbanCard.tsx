...
const ProductionKanbanCard: React.FC<ProductionKanbanCardProps> = ({ booking, currentUser, onSelect, onDragStart }) => {
    ...
    return (
        <Motion.div
            ...
            className="bg-lumina-base border border-lumina-highlight p-4 rounded-xl shadow-sm hover:border-lumina-accent/50 cursor-grab active:cursor-grabbing group relative overflow-hidden transition-colors"
        >
            {/* Card Content */}
